    	...
    	<form id="manage-form" action="">
    		<ul class="mod-form-rows base-form" id="base-form">
    			...
    			<li class="row-item odd row-category">
    				<div class="label-wrap"><label for="category">客户分组</label></div>
				...
				<li class="row-item  row-category">
    				<div class="label-wrap"><label for="staff">归属业务员</label></div>
    				<div class="ctn-wrap"><span id="staff"></span></div>
    			</li>
    		</ul>
...
<script src="<?php echo base_url()?>statics/js/dist/customerManage.js?ver=2020011022011"></script>
</body>
</html>
