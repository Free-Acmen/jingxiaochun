    ...
    <div id="manage-wrap" class="manage-wrap">
    	<form id="manage-form" action="">
    		<ul class="mod-form-rows base-form cf" id="base-form">
				...
				<li class="row-item odd">
    				<div class="label-wrap"><label for="date">开户名</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="bankMan" id="bankMan" /></div>
    			</li>
				<li class="row-item ">
    				<div class="label-wrap"><label for="date">开户行</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="bankName" id="bankName" /></div>
    			</li>
				<li class="row-item odd">
    				<div class="label-wrap"><label for="date">银行账号</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="cardNo" id="cardNo" /></div>
    			</li>
    			<li class="row-item">
    			...
    			<li class="row-item ">
    				<div class="label-wrap"><label for="taxRate">增值税率<span>%</span></label></div>
...
<script src="<?php echo base_url()?>/statics/js/dist/vendorManage.js?ver=20190818"></script>
</body>
</html>
