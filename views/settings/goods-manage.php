            ...
            <form id="manage-form" action="">
                <ul class="mod-form-rows base-form cf" id="base-form">
                    <li class="row-item">
                        ...
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="number" id="number">
                    ...
                    <li class="row-item">
                        <div class="label-wrap"><label for="udf03">生产日期</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="udf03" id="udf03"></div>
                    </li>
					<li class="row-item">
                        <div class="label-wrap"><label for="udf04">有效期天数</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="udf04" id="udf04"></div>
                    </li>
					<li class="row-item">
                        <div class="label-wrap"><label for="udf05">货位</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="udf05" id="udf05"></div>
                    </li>
                ...
                <div class="liGroup cf">
                    ...
                    <ul class="mod-form-rows base-form cf">
                        ...
                        <li class="row-item">
                            <div class="label-wrap"><label for="wholesalePrice">单品代理</label></div>
                            <div class="ctn-wrap"><input type="text" value="" class="ui-input money" name="wholesalePrice" id="wholesalePrice"></div>
                        </li>

                        <li class="row-item">
                            <div class="label-wrap"><label for="vipPrice">代理价格</label></div>
            ...
            <div class="cf">
                ...
                <div class="contacters">
                    <div class="grid-wrap">
                      ...
                      <div id="pagePrice">
							<iframe id="pagePriceFrame" src="" frameborder="0" width="100%" height="360px" style="overflow-x: hidden;overflow-y: scroll"  ></iframe>
...
<script src="<?php echo base_url()?>statics/js/dist/goodsManage.js?ver=20200110022144"></script>
