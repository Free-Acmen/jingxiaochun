...
<table width="1500px" class="list">
  			<tr><td class='H' align="center" colspan="21"><h3>采购申请记录</h3></td></tr>
  		</table>
		<table width="1500px" class="list"  border="1">
			<thead>
				<tr>
					...
					<th width="60" align="center">草根屁金额</th>
					<th width="60" align="center">采购申状态</th>
					...
					<th width="60" align="center">采购单价</th>	
