...
<head>
<title><?php echo $transType==160601 ? '采购申请' :'采购退货申请'?></title>
...
<?php for($t=1; $t<=$countpage; $t++){?>
		<table  width="800"  align="center">
			...
			<tr height="15px">
				<td align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;height:25px;"><?php echo $transType==160601 ? '采购申请' :'采购退货申请'?></td>
			</tr>
		</table>	
		...
		<table width="800" align="center">
			<tr height="15" align="left">
				<td width="220" style="font-family:'宋体'; font-size:12px;height:20px;">供应商：<?php echo $contactNo.' '.$contactName?> </td>
				<td width="120" style="font-family:'宋体'; font-size:12px;height:20px;">采购人员：<?php echo $salesName?></td>
		...
		<table width="900" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">   
			<tr style="height:20px">
					...
					<td width="60" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">采购单价</td>	
