...
<div class="print-settings-wrap">
  ...
  <div class="settings-ctn" id="printSettings">
      <div class="item">
        ...
        <ul class="mod-form-rows" id="pdfSettings">
          <li class="row-item">
            ...
            <div class="ctn-wrap">
              <span class="radio-wrap"><input type="radio" name="paperType"  value="0" checked="checked"/><labe>A4</label></span>
			  <span class="radio-wrap"><input type="radio" name="paperType"  value="1" /><labe>三联</label></span>
            </div>
          </li>
          <!--<li class="row-item">
            <div class="label-wrap">
      ...
      <div class="item taoda-settings" id="taodaSettings" style="display:none;">
        <p class="print-tips" id="taodaTips">为了保证您的正常打印，请先下载安装<a href="/noteprinttemp.do?action=downloadTemplateReader" target="_blank">PDF</a></p>
...
<script>
 (function($){
    ...
    function pdfPrint(){
	  ...
	  var tp=$("input[name='paperType']:checked").val();
      Business.getFile(pdfUrl+"&tp="+tp, pdfData, true, false);
      frameElement.api.close();
    }
