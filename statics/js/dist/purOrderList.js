var queryConditions = {
	...
	THISPAGE = {
		init: function() {
			SYSTEM.isAdmin !== !1 || SYSTEM.rights.AMOUNT_OUTAMOUNT || (hiddenAmount = !0), this.mod_PageConfig = Public.mod_PageConfig.init("purchaseOrderList"), this.initDom(), this.loadGrid(), this.addEvent()
		},
		initDom: function() {
		...
		loadGrid: function() {
			...
			function b(a, b, c) {
				return 150501 === a ? "采购申请" : (d.markRow.push(c.id), "采购退货")
			}
