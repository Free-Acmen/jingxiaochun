...
var queryConditions = {
	matchCon: "",
	locationId: -1,
	transTypeId:GetQueryString("transTypeId")
},
	hiddenAmount = !1,
	...
	THISPAGE = {
		...
		addEvent: function() {
			...
			$("#search").click(function() {
				queryConditions.matchCon = "请输入单据号或供应商或备注" === a.$_matchCon.val() ? "" : a.$_matchCon.val(), queryConditions.beginDate = a.$_beginDate.val(), queryConditions.endDate = a.$_endDate.val(), queryConditions.locationId = -1, queryConditions.transTypeId = GetQueryString("transTypeId"), THISPAGE.reloadData(queryConditions)
